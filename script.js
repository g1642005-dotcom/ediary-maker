...
const TEXT_HEIGHT = (460 / 1200) * 100 + '%';
const IMAGE_TOP = (720 / 1200) * 100 + '%';
const IMAGE_LEFT = (170 / 1200) * 100 + '%';
const IMAGE_WIDTH = (860 / 1200) * 100 + '%';
const IMAGE_HEIGHT = (300 / 1200) * 100 + '%';

const layouts = {
    "images/background1-text.png": {
        text: { top: TEXT_TOP, left: TEXT_LEFT, width: TEXT_WIDTH, height: TEXT_HEIGHT, textAlign: 'left' },
        image: { display: 'none' }
    },
